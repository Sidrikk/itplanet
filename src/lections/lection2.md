...
**Лекция 2.**  **Содержание, классификация, принципы и основные особенности**  **информационны**** е **** систем ****ы**
...
1. _учебное пособие / О.Г. Инюшкина, Екатеринбург: «Форт-Диалог Исеть», 2014. 240 с._
2. _учебное пособие. В 2 ч. Ч. 1 / А. А. Голованов. – Киров: ФГБОУ ВПО «ВятГУ», 2014. – 103с._
3. Горбенко, А.О. Информационные системы в экономике [Текст] / А.О. Горбенко. – М.: Бином, 2013. – 292 с.
...
![](RackMultipart20230331-1-m8g10k_html_31d29485f2396935.png)

_Рисунок 1 -_ _Классификация проектов_
...
По типу хранимых данныхИС делятся на фактографические и документальные. Фактографические системы предназначены для хранения и обработки структурированных данных в виде чисел и текстов. Над такими данными можно выполнять различные операции. В документальных системах информация представлена в виде документов, состоящих из наименований, описаний, рефератов и текстов. Поиск по неструктурированным данным осуществляется с использованием семантических признаков. Отобранные документы предоставляются пользователю, а обработка данных в таких системах практически не производится.
...
![](RackMultipart20230331-1-m8g10k_html_66d411015a094cfd.png)

Рисунок 2 – Класcификацияинформационных систем
...
| Анализ и установление цены | Участие в формировании заказов поставщикам | Финансовый анализ и прогнозирование |
...
2. Этапы создание ИС
3. Основные областипроектирование информационных систем
